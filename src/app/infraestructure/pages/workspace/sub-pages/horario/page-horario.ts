...
import { TemplateHorario } from '../../../../../components/templates/workspace/horario/horario';
...
export default class PageHorario {
      ...
      protected horarioParams = signal<{ year: string; dni: string } | null>(null);
      ...
      protected daysHorario = toSignal(
            computed(() => {
                  ...
                  return this.horarioService.obtenerHorarioPorTemporada(params.year, params.dni);
            })().pipe(
                  catchError((error) => {
